				...
				<?php 
					...
					$ket = mysql_fetch_array($sql1);
						...
						if(($_POST['slctTahun'] == "") &&($_POST['id_sumber'] == "")){
							...
							$sql = mysql_query("SELECT * FROM tfr t , kabupaten k, sumber s WHERE t.id_sumber = s.id_sumber AND t.kode_kab = k.kode_kab AND t.id_sumber = '$_POST[id_sumber]' AND t.tahun = '$_POST[slctTahun]' ");
							$content = "
							
							<h3 style='border-bottom:0px solid #000;'><center> Angka TFR Jawa Tengah<br> Berdasarkan $ket[nama_sumber] Tahun $_POST[slctTahun] </h3>
							<br>						
