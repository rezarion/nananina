...
<div class="widget">
	<h4 class="widgettitle">Form Data Potensi Ekonomi</h4>
	<div class="widgetcontent">
		<form class="stdform" action="component/proses_input_potensi.php" method="post" enctype="multipart/form-data">
			...
			<p>
				<label>Nilai</label>
				<span class="field"><input type="text" onkeypress="return numbersonly(event, false)" id="" name="nilai_potensi" class="input-xlarge" style= 'margin-left:0.1%;!important' maxlength="20" placeholder="masukkan nilai potensi ekonomi" required/></span>
			</p>
