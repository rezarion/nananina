...
<?php
	...
	$query = mysql_query("SELECT * FROM kepadatan_penduduk a, kelurahan b, kecamatan c
	...
	//$query =mysql_query("SELECT * FROM kepadatan_penduduk") or die (mysql_error());
    ...
    echo "<div class=\"widget\">
			<h4 class=\"widgettitle\">Lihat Data Kepadatan Penduduk</h4>
            ...
            <table id=\"dyntable\" class=\"table table-bordered responsive\">
				...
				while($pecah = mysql_fetch_array($query)){
					echo "<tr class=\" \">
						...
						<td style='width:20%;'><center>$pecah[nilai_kepadatan]</td>
						<td class=\"center\" style=\"width: 5%;\">
							<a href= \"main.php?menu=editKepadatan&id_kepadatan=$pecah[id_kepadatan]\" title=\"Edit\"><i  class=\"icon-edit\"></i></a>
							<a href=\"main.php?menu=hapusKepadatan&id_kepadatan=$pecah[id_kepadatan]\" title=\"Hapus\" onClick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?')\" class=\"icon-trash\"><i></i></a>
						</td>";
