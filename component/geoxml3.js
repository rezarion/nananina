  ...
  var createMarker = function (placemark, doc) {
    ...
    if (!parserOptions.suppressInfoWindows) {
      ...
      var infoWindowOptions = geoXML3.combineOptions(parserOptions.infoWindowOptions, {
        ...
        content: '<div class="geoxml3_infowindow"><b>' + placemark.name + '<div>' + placemark.description + '</b></div>' + '<div>' + event.latLng + '</div></div>',
...
var createPolygon = function(placemark, doc) {
  ...
  if (!parserOptions.suppressInfoWindows) {
    ...
    google.maps.event.addListener(p, 'click', function(e) {
      ...
      p.infoWindow.setContent('<div class="geoxml3_infowindow"><b>' + placemark.name + '<div>' + placemark.description + '</b></div>' + '<div>' + 'Clicked location : '+ '</br>' + e.latLng.lat() + ', ' + e.latLng.lng() + '</div></div>');
