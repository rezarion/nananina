...
<div class="widget">
	<h4 class="widgettitle">Form Data Keberadaan Sarana</h4>
	<div class="widgetcontent">
		<form class="stdform" action="component/proses_input_keberadaan.php" method="post" enctype="multipart/form-data">
			...
			<p>
				<label>Jumlah</label>
				<span class="field"><input type="text" onkeypress="return numbersonly(event, false)" id="" name="banyak_sarana" class="input-xlarge" style= 'margin-left:0.1%;!important' maxlength="20" placeholder="masukkan nilai keberadaan sarana" required/></span>
			</p>
