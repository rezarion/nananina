...
<div class="widget">	
	<h4 class="widgettitle">Form Data Lokasi Pasar Tradisional</h4>
	<div class="widgetcontent">
		<form class="stdform" action="component/proses_input_pasar.php" method="post" enctype="multipart/form-data">		
						
			<p>
				<label>Nama Pasar</label>
				<span class="field">
					<input type="text" id="nama" name="nama" class="input-xlarge" style= 'margin-left:0.1%;!important' maxlength="50" placeholder="masukkan nama pasar tradisional" required/>
				</span>
			</p>
			...
			<p>
				...
				<span class="field">
					<input type="text" id="golongan" name="golongan" class="input-xlarge" style= 'margin-left:0.1%;!important' maxlength="50" placeholder="masukkan golongan pasar tradisional" required/>
				</span>
			</p>
			...
			<p>
				<label>UPTD</label>
				<span class="field">
					<input type="text" id="uptd" name="uptd" class="input-xlarge" style= 'margin-left:0.1%;!important' maxlength="50" placeholder="masukkan uptd pasar tradisional" required/>
				</span>
			</p>
			...
			<p>
				<label>Alamat</label>
				<span class="field">
					<textarea id="autoResizeTA" name="alamat" class="input-xlarge" style="resize: vertical; height: 117px;" rows="5" cols="80" placeholder="masukkan alamat pasar tradisional" required/></textarea>
				</span>
			</p>
			<p>
				<label>Tahun</label>
