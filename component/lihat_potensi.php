...
<?php
	...
	$query = mysql_query("SELECT * FROM potensi_ekonomi a, kelurahan b, kecamatan c
	...
	//$query =mysql_query("SELECT * FROM potensi_ekonomi") or die (mysql_error());
    ...
    echo "<div class=\"widget\">
			<h4 class=\"widgettitle\">Lihat Data Potensi Ekonomi</h4>
            ...
            <table id=\"dyntable\" class=\"table table-bordered responsive\">
				...
				while($pecah = mysql_fetch_array($query)){
					echo "<tr class=\" \">
						...
						<td style='width:20%;'><center>$pecah[nilai_potensi]</td>
						<td class=\"center\" style=\"width: 5%;\">
							<a href= \"main.php?menu=editPotensi&id_potensi=$pecah[id_potensi]\" title=\"Edit\"><i  class=\"icon-edit\"></i></a>
							<a href=\"main.php?menu=hapusPotensi&id_potensi=$pecah[id_potensi]\" title=\"Hapus\" onClick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?')\" class=\"icon-trash\"><i></i></a>
						</td>";
