...
<div class="widget">
	<h4 class="widgettitle">Form Data Arus Lalu Lintas</h4>
	<div class="widgetcontent">
		<form class="stdform" action="component/proses_input_arus.php" method="post" enctype="multipart/form-data">
			...
			<p>
				<label>Nilai</label>
				<span class="field"><input type="text" id="" name="nilai_arus" class="input-xlarge" style= 'margin-left:0.1%;!important' maxlength="20" placeholder="masukkan nilai arus lalu lintas" required/></span>
			</p>
