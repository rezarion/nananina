...
<?php
	...
	$query = mysql_query("SELECT * FROM keberadaan_sarana a, kelurahan b, kecamatan c
	...
	//$query =mysql_query("SELECT * FROM keberadaan_sarana") or die (mysql_error());
    ...
    echo "<div class=\"widget\">
			<h4 class=\"widgettitle\">Lihat Data Keberadaan Sarana</h4>
            ...
            <table id=\"dyntable\" class=\"table table-bordered responsive\">
				...
				while($pecah = mysql_fetch_array($query)){
					echo "<tr class=\" \">
						...
						<td style='width:20%;'><center>$pecah[banyak_sarana]</td>
						<td class=\"center\" style=\"width: 5%;\">
							<a href= \"main.php?menu=editKeberadaan&id_keberadaan=$pecah[id_keberadaan]\" title=\"Edit\"><i  class=\"icon-edit\"></i></a>
							<a href=\"main.php?menu=hapusKeberadaan&id_keberadaan=$pecah[id_keberadaan]\" title=\"Hapus\" onClick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?')\" class=\"icon-trash\"><i></i></a>
						</td>";
