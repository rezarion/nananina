...
<?php
	...
	$id = htmlentities( htmlspecialchars (addslashes ($_GET['id_toko'])));
	//$id = isset($_GET['id']) ? $_GET['id'] : '';
	$query =mysql_query("SELECT * FROM lokasi_toko, kelurahan, kecamatan
							WHERE id_toko = '$id'
							AND lokasi_toko.id_kelurahan = kelurahan.id_kelurahan
...
<div class="widget">
	<h4 class="widgettitle">Form Edit Data Lokasi Toko Modern</h4>
	<div class="widgetcontent">
		<form class="stdform" action="component/proses_edit_toko.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
			
			<p>
				<label>No.</label>
				<span class="field"><input type="text" name="id_toko" class="input-medium" style= 'margin-left:0.1%;!important' value="<?php echo $id; ?>" readonly /></span>
			</p>

			<p>
				<label>Nama Toko</label>
				<span class="field"><input type="text" id="nama" name="nama" class="input-xlarge" style= 'margin-left:0.1%;!important' maxlength="50" value="<?php echo $ss['nama_toko']; ?>" required/></span>
			</p>

			<p>
				<label>Jenis</label>
				<span class="field"><input type="text" id="jenis" name="jenis" class="input-xlarge" style= 'margin-left:0.1%;!important' maxlength="50" value="<?php echo $ss['jenis']; ?>" required/></span>
			</p>
			
			<p>
				<label>Ijin</label>
				<span class="field"><input type="text" id="ijin" name="ijin" class="input-xlarge" style= 'margin-left:0.1%;!important' maxlength="50" value="<?php echo $ss['ijin']; ?>" required/></span>
			</p>
			
			<p>
				<label>Terbit</label>
				<span class="field"><input type="text" id="datepicker" name="terbit" class="input-xlarge" style= 'margin-left:0.1%;!important' maxlength="50" value="<?php echo $ss['terbit']; ?>" required/></span>
			</p>
			...
			<p>
				<label>Alamat</label>
				<span class="field">
					<textarea id="autoResizeTA" name="alamat" class="input-xlarge" style="resize: vertical; height: 117px;" rows="5" cols="80" required/> <?php echo $ss['alamat_toko']; ?> </textarea>
				</span>
			</p>
			<p>
				<label>Tahun </label>
