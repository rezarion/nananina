...
<?php
	...
	$query = mysql_query("SELECT * FROM perkembangan_pemukiman a, kelurahan b, kecamatan c
	...
	//$query =mysql_query("SELECT * FROM perkembangan_pemukiman") or die (mysql_error());
    ...
    echo "<div class=\"widget\">
			<h4 class=\"widgettitle\">Lihat Data Perkembangan Pemukiman Baru</h4>
            ...
            <table id=\"dyntable\" class=\"table table-bordered responsive\">
                <thead>
                    <tr>
						...
						<th><center>Nilai perkembangan</th>
						<th><center>Aksi</th>
                    </tr>
                </thead>
				<tbody>";
				...
				while($pecah = mysql_fetch_array($query)){
					echo "<tr class=\" \">
						...
						<td style='width:20%;'><center>$pecah[nilai_perkembangan]</td>
						<td class=\"center\" style=\"width: 5%;\">
							<a href= \"main.php?menu=editPerkembangan&id_perkembangan=$pecah[id_perkembangan]\" title=\"Edit\"><i  class=\"icon-edit\"></i></a>
							<a href=\"main.php?menu=hapusPerkembangan&id_perkembangan=$pecah[id_perkembangan]\" title=\"Hapus\" onClick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?')\" class=\"icon-trash\"><i></i></a>
						</td>";
