...
<?php
	...
	$id = htmlentities( htmlspecialchars (addslashes ($_GET['id_perkembangan'])));
	$query = mysql_query("SELECT * FROM perkembangan_pemukiman, kelurahan, kecamatan
							WHERE id_perkembangan = '$id'
							AND perkembangan_pemukiman.id_kelurahan = kelurahan.id_kelurahan
							AND kelurahan.id_kecamatan = kecamatan.id_kecamatan							
							ORDER BY tahun DESC, kecamatan.id_kecamatan ASC");
							//JOIN perkembangan_pemukiman ON perkembangan_pemukiman.id_kelurahan = kelurahan.id_kelurahan
							//JOIN kelurahan ON perkembangan_pemukiman.id_kecamatan = kelurahan.id_kelurahan
							//JOIN kecamatan ON kelurahan.id_kecamatan = kecamatan.id_kecamatan
	//$query = mysql_query("SELECT * FROM perkembangan_pemukiman WHERE id_perkembangan = '$id'");
...
<div class="widget">
	<h4 class="widgettitle">Form Ubah Data Perkembangan Pemukiman Baru</h4>
	<div class="widgetcontent">
		<form class="stdform" action="component/proses_edit_perkembangan.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
			
			<p>
				<label>No. </label>
				<span class="field"><input type="text" id="" name="id_perkembangan" class="input-medium" style= 'margin-left:0.1%;!important' value="<?php echo $id; ?>" readonly /></span>
			</p>
			...
			<p>
				...
				<span class="field"><input type="text" id="s1" name="kecamatan" class="input-medium" style= 'margin-left:0.1%;!important' value="<?php echo $pecah['nama_kecamatan']; ?>" readonly /></span>
				<!--<span class="field">
			...
			<p>
				...
				<span class="field"><input type="text" id="display_hasil" name="kelurahan" class="input-medium" style= 'margin-left:0.1%;!important' value="<?php echo $pecah['Kelurahan']; ?>" readonly /></span>
			...
			<p>
				<label>Nilai </label>
				<span class="field"> <input type="text" onkeypress="return numbersonly(event, false)" id="" name="nilai_perkembangan" class="input-xlarge" style= 'margin-left:0.1%;!important' maxlength="20" value="<?php echo $pecah['nilai_perkembangan']; ?>"  required/></span>
			</p>
