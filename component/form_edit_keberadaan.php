...
<?php
	...
	$id = htmlentities( htmlspecialchars (addslashes ($_GET['id_keberadaan'])));
	$query = mysql_query("SELECT * FROM keberadaan_sarana, kelurahan, kecamatan
							WHERE id_keberadaan = '$id'
							AND keberadaan_sarana.id_kelurahan = kelurahan.id_kelurahan
							AND kelurahan.id_kecamatan = kecamatan.id_kecamatan							
							ORDER BY tahun DESC, kecamatan.id_kecamatan ASC");
							//JOIN keberadaan_sarana ON keberadaan_sarana.id_kelurahan = kelurahan.id_kelurahan
							//JOIN kelurahan ON keberadaan_sarana.id_kecamatan = kelurahan.id_kelurahan
							//JOIN kecamatan ON kelurahan.id_kecamatan = kecamatan.id_kecamatan
	//$query = mysql_query("SELECT * FROM keberadaan_sarana WHERE id_keberadaan = '$id'");
...
<div class="widget">
	<h4 class="widgettitle">Form Ubah Data Keberadaan Sarana</h4>
	<div class="widgetcontent">
		<form class="stdform" action="component/proses_edit_keberadaan.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
			
			<p>
				<label>No. </label>
				<span class="field"><input type="text" id="" name="id_keberadaan" class="input-medium" style= 'margin-left:0.1%;!important' value="<?php echo $id; ?>" readonly /></span>
			</p>
			...
			<p>
				<label>Jumlah </label>
				<span class="field"> <input type="text" onkeypress="return numbersonly(event, false)" id="" name="banyak_sarana" class="input-xlarge" style= 'margin-left:0.1%;!important' maxlength="20" value="<?php echo $pecah['banyak_sarana']; ?>"  required/></span>
			</p>
